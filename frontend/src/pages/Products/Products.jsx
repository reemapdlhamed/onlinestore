...
function Products() {
  ...
  return (
    ...
    >
      <div
        className="d-flex flex-wrap justify-content-around align-content-center"
        style={{
          width: "70%",
          height: "60px",
      ...
      >
        ...
        {CategoriesList.map((cat) => {
          return <Chip label={cat.name} onClick={() => categoryClick(cat)} />;
        })}
      </div>
      <TextField
        style={{ width: "20%", marginTop: "60px" }}
        id="outlined-basic"
        label="Search"
        value={searchWord}
        variant="outlined"
