...
exports.googleLogin = function _callee6(req, res) {
  var tokenId, verify, _verify$payload, email_verified, email, name, password, passwordHash, user, isMatch, refresh_token, newUser, _refresh_token;
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.next = 4;
          return regeneratorRuntime.awrap(user.verifyIdToken({
            idToken: tokenId,
