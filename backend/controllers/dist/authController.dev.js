...
var sendEmail2 = require("./email");

var Token = require("../models/token");

var crypto = Promise.resolve().then(function () {
...
exports.register = asyncHandler(function _callee(request, response, next) {
  var errors, error, hashed, user, newUser, token, message;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 15:
          token = _context.sent;
          //console.log(token)
          message = "".concat(process.env.BASE_URL, "/user/verify/").concat(user.id, "/").concat(token.token);
          console.log(message);
          _context.next = 20;
          return regeneratorRuntime.awrap(sendEmail2(newUser.email, "Verify Email", message));
...
exports.getAccessToken = function (req, res) {// try {
...
exports.facebookLogin = function _callee7(req, res) {
  var _req$body, accessToken, userID, URL, data, email, name, picture, password, passwordHash, user, isMatch, newUser;
